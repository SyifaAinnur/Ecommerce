                ...
                $(data).each(function (index, product) {
                    if (product.price >= minPrice && product.price <= maxPrice) {
                        ...
                        $(".bestsellers__products").append(
                            ...
                            "</p >" +
                            "<p class=' card-text text-danger text-center ' > <span>$</span> " +
                            product.price.toFixed(2) + '</p></div> </a><div class=" d-flex justify-content-center align-items-center my-0 my-md-3 text-center products__buttons"><button class="btn btn-success mx-2 my-md-1 my-0 product__button cart-button" onclick="addToCart(' +
                            product.id + ', this)">' + "Add To Cart </button>" +
                            '<button class="btn btn-primary my-md-1 my-0 mx-2 product__button wish-button" onclick="addToWish(' +
                            product.id + ',this)">' + " Add To Wishlist " +
                            '</button></div><div class="card-footer position-absolute bottom-0  w-100 text-center">' +
                            '<small class="text-body-secondary">Last updated 3 days ago</small></div></div></div>'
                        );
                        // show electronics product
