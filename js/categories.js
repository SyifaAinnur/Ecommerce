class Categories {
    ...
    ratingFilter(value, slug) {
        fetch(this.apiUrl + "products/category/" + slug)
            ...
            .then(function (data) {
                console.log(data);
                console.log(value);
                let filteredProducts = data.filter(product => product.rating.rate <= value);
    ...
    // priceFilter(value, slug) {
    //     fetch(this.apiUrl + "products/category/" + slug)
    //         .then((res) => res.json())
    //         .then(function (data) {
    //             console.log(data);
    //             console.log(value);
    //             let filteredProducts = data.filter(product => product.price <= value);
    ...
    sortFilter(value, slug) {
        fetch(this.apiUrl + "products/category/" + slug + "?sort=" + value)
            .then((res) => res.json())
            .then(function (data) {
                console.log(data);
                console.log(value);
                ...
                data.forEach(function (product) {
                    ...
                    $(".products").append(
                        ...
                        encodeURIComponent(product.id) +
                        '">' +
                        '<h5 class="card-title text-center fs-5 fw-bold text-dark mt-md-2 mt-0" > ' + product.title + "</h5 >" + "<p class=' card-text text-secondary text-center mb-0 mb-md-2' >" + product.category + "</p >" + "<p class=' card-text text-danger text-center ' > <span>$</span> " + product.price.toFixed(2) + '</p></div> </a><div class=" d-flex justify-content-center align-items-center my-0 my-md-3 text-center products__buttons"><button class="btn btn-success mx-2 my-md-1 my-0 product__button cart-button" onclick="addToCart(' + product.id + ', this)">' + " Add To Cart </button>" + '<button class="btn btn-primary my-md-1 my-0 mx-2 product__button wish-button " onclick="addToWish(' + product.id + ',this)">' + " Add To Wishlist " + '</button></div><div class="card-footer position-absolute bottom-0  w-100 text-center">' + '<small class="text-body-secondary">Last updated 3 days ago</small></div></div></div>');
                });
